...
var _ node.PodLifecycleHandler = &SinaProvider{}
var _ node.PodNotifier = &SinaProvider{}
var _ node.NodeProvider = &SinaProvider{}

// CreatePod takes a Kubernetes Pod and deploys it within the provider.
func (v *SinaProvider) CreatePod(ctx context.Context, pod *corev1.Pod) error {
...
func (v *SinaProvider) UpdatePod(ctx context.Context, pod *corev1.Pod) error {
	if pod.Namespace == "kube-system" {
		return nil
	}
...
func (v *SinaProvider) DeletePod(ctx context.Context, pod *corev1.Pod) error {
	if pod.Namespace == "kube-system" {
		return nil
	}
...
func (v *SinaProvider) GetPod(ctx context.Context, namespace string, name string) (*corev1.Pod, error) {
...
// concurrently outside of the calling goroutine. Therefore it is recommended
// to return a version after DeepCopy.
func (v *SinaProvider) GetPodStatus(ctx context.Context, namespace string, name string) (*corev1.PodStatus, error) {
	pod, err := v.clientCache.podLister.Pods(namespace).Get(name)
	if err != nil {
		return nil, fmt.Errorf("could not get pod %s/%s: %v", namespace, name, err)
	}
...
// concurrently outside of the calling goroutine. Therefore it is recommended
// to return a version after DeepCopy.
func (v *SinaProvider) GetPods(_ context.Context) ([]*corev1.Pod, error) {
...
func (v *SinaProvider) GetContainerLogs(ctx context.Context, namespace string,
...
func (v *SinaProvider) RunInContainer(ctx context.Context, namespace string, podName string, containerName string, cmd []string, attach api.AttachIO) error {
	defer func() {
...
func (v *SinaProvider) NotifyPods(ctx context.Context, f func(*corev1.Pod)) {
...
func (v *SinaProvider) AttachToContainer(ctx context.Context, namespace, podName, containerName string, attach api.AttachIO) error {
	return nil
}

func (v *SinaProvider) GetMetricsResource(context.Context) ([]*dto.MetricFamily, error) {
	return nil, nil
}

func (v *SinaProvider) GetStatsSummary(context.Context) (*statsv1alpha1.Summary, error) {
	return nil, nil
}

func (v *SinaProvider) PortForward(ctx context.Context, namespace, pod string, port int32, stream io.ReadWriteCloser) error {
	return nil
}

// createSecrets takes a Kubernetes Pod and deploys it within the provider.
func (v *SinaProvider) createSecrets(ctx context.Context, secrets []string, ns string) error {
	for _, secretName := range secrets {
		...
		util.SetObjectGlobal(&secret.ObjectMeta)
...
func (v *SinaProvider) createServiceAccount(ctx context.Context, secret *corev1.Secret) error {
...
func (v *SinaProvider) createConfigMaps(ctx context.Context, configmaps []string, ns string) error {
	for _, cm := range configmaps {
		...
		if errors.IsNotFound(err) {
			...
			util.SetObjectGlobal(&configMap.ObjectMeta)
...
func (v *SinaProvider) deleteConfigMaps(ctx context.Context, configmaps []string, ns string) error {
	for _, cm := range configmaps {
...
func (v *SinaProvider) createPVCs(ctx context.Context, pvcs []string, ns string) error {
	for _, cm := range pvcs {
		...
		if errors.IsNotFound(err) {
			...
			util.SetObjectGlobal(&pvc.ObjectMeta)
