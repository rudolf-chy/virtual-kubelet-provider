...
func (v *SinaProvider) ConfigureNode(ctx context.Context, node *corev1.Node) {
...
func (v *SinaProvider) Ping(ctx context.Context) error {
...
func (v *SinaProvider) NotifyNodeStatus(ctx context.Context, f func(*corev1.Node)) {
...
func (v *SinaProvider) UpdateStatus(ctx context.Context, node *corev1.Node) error {
...
// within Kubernetes.
func (v *SinaProvider) nodeDaemonEndpoints() corev1.NodeDaemonEndpoints {
...
func (v *SinaProvider) getResourceFromPods() *common.Resource {
...
func (v *SinaProvider) getResourceFromPodsByNodeName(nodeName string) *common.Resource {
	podResource := common.NewResource()
